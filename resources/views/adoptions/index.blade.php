...
@section('title', 'Module Adoptions: Larapets 🐻‍❄️')
...
<div class="join mx-auto">
    <a class="btn btn-outline btn-error join-item" href="{{ url('export/adoptions/pdf') }}">
    ...
    <a class="btn btn-outline btn-success join-item" href="{{ url('export/adoptions/excel') }}">
        <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
            <path

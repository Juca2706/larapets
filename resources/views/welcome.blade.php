...
@section('title', 'Welcome: Larapets 🐻‍❄️')

@section( 'content')
    <section class="bg-[#0006] rounded-lg w-96 p-8 flex flex-col gap-4 items-center justify-center">
         <img src="{{ asset('images/logo-sinFondo.png') }}" width="280px" alt="">
        <p class="text-white">
           <strong>LaraPets</strong>, our corner of hope. Adopt and experience the most beautiful adventure: giving a second chance and receiving unconditional love. 
           Your new best friend is ready for you.
        </p>
        <div class="flex gap-2 mt-8">
            @guest()
            <a class="btn btn-outline btn-accent w-[160px]" href="{{ url('login') }}">
            ...
            <a class="btn btn-outline btn-warning w-[160px]" href="{{ url('register') }}">
            ...
            @endguest
            @auth()
            <a class="btn btn-outline btn-success w-[160px]" href="{{ url('dashboard') }}">
